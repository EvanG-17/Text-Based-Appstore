...
public class Driver {
    ...
    private void runMainMenu() {
        ...
        while (option != 0) {
            switch (option) {
                ...
                case 2 ->  runAppStoreMenu();//TODO run the App Store Menu and the associated methods (your design here)
    ...
    public void addApp(){
        int developerIndex = ScannerInput.validNextInt("Enter the developers index");
        ...
        appStoreAPI.addApp(new App(developerAPI.getDevelopers().get(developerIndex),appName,appSize,appVersion,appCost){
